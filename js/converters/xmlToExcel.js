...
export function detectXmlRowTags(xmlDoc) {
    ...
    for (let i = 0; i < elements.length; i++) {
        ...
        // Skip document root element (usually doesn't repeat)
    ...
    // Find the first tag that has children, which typically represents records!
    let defaultTag = sortedTags.length > 0 ? sortedTags[0].name : '';
