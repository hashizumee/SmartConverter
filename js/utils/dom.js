...
export const elements = {
    ...
    excel: {
        ...
        typeSelectGroup: document.getElementById('excel-type-select-group'),
        typeColumn: document.getElementById('excel-type-column'),
        rowNodeGroup: document.getElementById('excel-row-node-group'),
